...
products = Product.create!([
    {id: 1, product_name: "Bali, Indonesia", product_description: "Bali is a living postcard, an Indonesian paradise that feels like a 
    ...
    {id: 2, product_name: "London, United Kingdom", product_description: "The crown jewels, Buckingham Palace, Camden Market…in London, 
    ...
    {id: 3, product_name: "Paris, France", product_description: "Lingering over pain au chocolat in a sidewalk café, relaxing after a day 
    ...
    {id: 4, product_name: "Rome, Italy", product_description: "Rome wasn't built in a day--and you'll need much more than a day to take in 
    ...
    {id: 5, product_name: "Crete, Greece", product_description: "The birthplace of both the king of the Olympian gods and of modern European 
    ...
    born.", price: 2.99},
    {id: 6, product_name: "Barcelona, Spain", product_description: "Barcelona feels a bit surreal – appropriate, since Salvador Dali spent 
    ...
    {id: 7, product_name: "Siem Reap, Cambodia", product_description: "When the morning light washes over the overgrown temples and ruins of 
    ...
    {id: 8, product_name: "Prague, Czech Republic", product_description: "The bohemian allure and fairytale features of Prague make it a perfect 
    ...
    {id: 9, product_name: "Phuket, Thailand", product_description: "Thailand’s largest island is an international magnet for beach lovers and 
    ...
    {id: 10, product_name: "Rio de Janeiro, Brazil", product_description: "With its plentiful beaches, dramatic mountains, and backdrop of 
    samba and bossa nova rhythms, it's easy to fall in love with Rio de Janeiro. Made famous in song, Ipanema Beach is still the place to 
    stroll, sunbathe, and be seen. The largest Art Deco statue in the world, Christ the Redeemer, beckons visitors to Corcovado Mountain. 
    Rio’s annual Carnaval celebrations are bacchanalian extravaganzas of feasting, music, dance, and costumed revelry.", price: 1.99},
])
